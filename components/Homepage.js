...
const Main = () => {
    ...
    return (
        ...
        <div className={styles.courses}>
          <h2 style={{textAlign:"center", fontSize:"50px", color:"#4a42ec", paddingTop:"50px"}}>Our Popular courses</h2>
